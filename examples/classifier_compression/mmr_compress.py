...
# from mmr_dataset import mmr_dataset
# import peleenet
...
parser.add_argument('--data', dest='data', metavar='DIR', default ='/opt/data/calib_mmr/', help='path to dataset')
...
#                     default='/opt/distiller/examples/agp-pruning/peleenet_mmr_baseline_training.yaml',
#                     help='configuration file for pruning the model (default is to use hard-coded schedule)')
parser.add_argument('--compress', dest='compress', type=str, nargs='?', action='store',
                    default='/opt/distiller/examples/sensitivity-pruning/alexnet.schedule_sensitivity.yaml',
                    help='configuration file for pruning the model (default is to use hard-coded schedule)')
...
parser.add_argument('--num_classes', type=int, dest='num_classes', default=3341,
                    help='classes number')
